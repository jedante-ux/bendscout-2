...
import { FirstResponseGame } from "@/components/games/first-response-game";
...
export default function PrimeraRespuestaPage() {
  return (
    <Suspense fallback={null}>
      <PrimeraRespuestaPageInner />
    </Suspense>
  );
}

function PrimeraRespuestaPageInner() {
    ...
    return (
      <IntroLayout>
        {dayStatus ? (
          <>
            <GameIntroCard
              title={meta?.title ?? "Primera Respuesta"}
              tagline={
                meta?.tagline ??
            ...
            />
            <ScoresPanel
              gameTitle={meta?.title ?? "Primera Respuesta"}
              dayStatus={dayStatus}
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="60 s — encadena aciertos para sumar más puntos. Una respuesta mal te resta 30."
              />
            )}
          </>
        )}
  ...
  return (
    <Overlay>
      <div className="text-center">
        ...
        >
          <ScoutIcon name="sparkle" size={22} />
        </div>
    ...
    <Overlay>
      <div className="text-center">
        ...
        <p
          ...
          style={{ marginTop: 6, textWrap: "balance" }}
        >
          {copy.body}
        </p>
        <Link
