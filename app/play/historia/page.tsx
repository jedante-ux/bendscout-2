...
import { HistoriaGame } from "@/components/games/historia-game";
...
function HistoriaPageInner() {
  ...
  const fallbackTitle = "Historia Scout";
  const fallbackTagline =
    "Ordena los hitos del escultismo del más antiguo al más reciente. ¡60s para resolver rondas seguidas!";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Arrastra los eventos para ordenarlos por año"
              />
            )}
          </>
        )}
    ...
    <Overlay>
      <div className="text-center">
        ...
        <p className="t-body-sm text-muted" style={{ marginTop: 12 }}>
          Abriendo el baúl de la historia…
        </p>
      </div>
    </Overlay>
  );
