...
import { NudoPasosGame } from "@/components/games/nudo-pasos-game";
...
export default function NudoPasosPage() {
  return (
...
function NudoPasosPageInner() {
  ...
  const fallbackTitle = "Nudo paso-a-paso";
  const fallbackTagline =
    "Ordena los 4 pasos del nudo correctamente. Aprende nudos en 60 segundos.";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Arrastra los pasos para ordenarlos"
              />
            )}
          </>
        )}
