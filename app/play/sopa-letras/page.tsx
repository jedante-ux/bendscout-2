...
import { SopaLetrasGame } from "@/components/games/sopa-letras-game";
...
function SopaLetrasPageInner() {
  ...
  const fallbackTitle = "Sopa de Letras Scout";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Arrastra desde la primera letra hasta la última"
              />
            )}
          </>
        )}
