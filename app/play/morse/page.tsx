...
import { MorseGame } from "@/components/games/morse-game";
...
function MorsePageInner() {
  ...
  const fallbackTitle = "Código Morse";
  const fallbackTagline =
    "Escucha el patrón y elige la letra correcta antes que se acabe el tiempo.";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Sube el volumen — toca Repetir para volver a escuchar"
              />
            )}
          </>
        )}
