...
import { CompletaLeyGame } from "@/components/games/completa-ley-game";
...
export default function CompletaLeyPage() {
  return (
    <Suspense fallback={null}>
      <CompletaLeyPageInner />
    </Suspense>
  );
}

function CompletaLeyPageInner() {
  ...
  const fallbackTitle = "Completa la Ley";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Lee la frase, elige la palabra que falta"
              />
            )}
          </>
        )}
