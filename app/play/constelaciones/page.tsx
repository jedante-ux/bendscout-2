...
import { ConstellationsGame } from "@/components/games/constellations-game";
...
export default function ConstelacionesPage() {
  return (
    <Suspense fallback={null}>
      <ConstelacionesPageInner />
    </Suspense>
  );
}

function ConstelacionesPageInner() {
    ...
    return (
      <IntroLayout>
        {dayStatus ? (
          <>
            <GameIntroCard
              title={meta?.title ?? "Constelaciones"}
              tagline={
                meta?.tagline ??
                "Identifica la constelación correcta antes de que termine el tiempo."
              }
            ...
            />
            <ScoresPanel
              gameTitle={meta?.title ?? "Constelaciones"}
              dayStatus={dayStatus}
