...
import { SemaphoreGame } from "@/components/games/semaphore-game";
...
const GAME_KEY = "banderas-semaforas";
...
export default function BanderasSemaforasPage() {
  return (
    <Suspense fallback={null}>
      <BanderasSemaforasPageInner />
    </Suspense>
  );
}

function BanderasSemaforasPageInner() {
  ...
  const fallbackTitle = "Banderas Semáforas";
  const fallbackTagline =
    "Identifica la letra correcta del alfabeto semáforo antes que se acabe el tiempo.";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Tienes 60 s — encadena aciertos para sumar más puntos"
              />
            )}
          </>
        )}
