...
import { ConstruyeCarpaGame } from "@/components/games/construye-carpa-game";
...
export default function ConstruyeCarpaPage() {
  return (
    <Suspense fallback={null}>
      <ConstruyeCarpaPageInner />
    </Suspense>
  );
}

function ConstruyeCarpaPageInner() {
  ...
  const fallbackTitle = "Construye la Carpa";
  const fallbackTagline =
    "Arrastra cada pieza en el orden correcto al lugar correcto.";
