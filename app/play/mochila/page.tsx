...
import { MochilaGame } from "@/components/games/mochila-game";
...
function MochilaPageInner() {
  ...
  const fallbackTitle = "Mochila de Campamento";
  const fallbackTagline =
    "Swipea derecha para llevar, izquierda para dejar. ¡60 segundos para armar la mochila perfecta!";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Swipea ← para dejar, → para llevar"
              />
            )}
          </>
        )}
