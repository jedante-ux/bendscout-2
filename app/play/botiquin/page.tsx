...
import { BotiquinGame } from "@/components/games/botiquin-game";
...
function BotiquinPageInner() {
  ...
  const fallbackTitle = "Botiquín Express";
  const fallbackTagline =
    "Arrastra el ítem correcto del botiquín al paciente. Cuenta cada segundo.";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Arrastra (o toca) el ítem correcto al paciente"
              />
            )}
          </>
        )}
