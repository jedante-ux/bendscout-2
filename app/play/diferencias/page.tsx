...
import { DiferenciasGame } from "@/components/games/diferencias-game";
...
export default function DiferenciasPage() {
  return (
    <Suspense fallback={null}>
      <DiferenciasPageInner />
    </Suspense>
  );
}

function DiferenciasPageInner() {
  ...
  const fallbackTitle = "Encuentra las Diferencias";
  const fallbackTagline =
    "Compara las dos escenas y toca las 5 diferencias antes que se acabe el tiempo.";
          ...
          <>
            ...
            {!started && (
              <GameStartOverlay
                ...
                hint="Toca en cualquiera de las dos escenas donde veas algo distinto"
              />
            )}
          </>
        )}
